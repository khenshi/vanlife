...
(function() {
  ...
  m2.prototype.v = function(d2, a) {
    ...
    for (; g2 < a; ) {
      ...
      if (typeof d2 === "string") for (; g2 < a; ) {
        if (f[e++] = d2.charCodeAt(g2++), e == this.blockSize) {
          n(this, f);
          e = 0;
          break;
        }
      }
      else for (; g2 < a; ) if (f[e++] = d2[g2++], e == this.blockSize) {
        n(this, f);
        e = 0;
        break;
      }
  ...
  m2.prototype.A = function() {
    ...
    d2 = Array(16);
    a = 0;
    for (c = 0; c < 4; ++c) for (let f = 0; f < 32; f += 8) d2[a++] = this.g[c] >>> f & 255;
    return d2;
  };
  function p2(d2, a) {
    var c = q2;
  ...
  function v2(d2) {
    ...
    const a = [];
    let c = 1;
    for (let f = 0; d2 >= c; f++) a[f] = d2 / c | 0, c *= 4294967296;
    return new t(a, 0);
  }
  function y2(d2, a) {
  ...
  h.add = function(d2) {
    ...
    let f = 0;
    for (let e = 0; e <= a; e++) {
      let g2 = f + (this.i(e) & 65535) + (d2.i(e) & 65535), b2 = (g2 >>> 16) + (this.i(e) >>> 16) + (d2.i(e) >>> 16);
      f = b2 >>> 16;
      g2 &= 65535;
      b2 &= 65535;
      c[e] = b2 << 16 | g2;
  ...
  h.j = function(d2) {
    ...
    for (f = 0; f < this.g.length; f++) for (let e = 0; e < d2.g.length; e++) {
      const g2 = this.i(f) >>> 16, b2 = this.i(f) & 65535, r = d2.i(e) >>> 16, E2 = d2.i(e) & 65535;
      c[2 * f + 2 * e] += b2 * E2;
      G(c, 2 * f + 2 * e);
      c[2 * f + 2 * e + 1] += g2 * E2;
      G(c, 2 * f + 2 * e + 1);
  ...
  function D2(d2, a) {
    ...
    if (d2.g.length > 30) {
      ...
      for (var c = z, f = a; f.l(d2) <= 0; ) c = I2(c), f = I2(f);
      var e = J(c, 1), g2 = J(f, 1);
      f = J(f, 2);
      for (c = J(c, 2); !C2(f); ) {
        var b2 = g2.add(f);
    ...
    for (e = w2; d2.l(a) >= 0; ) {
      ...
      g2 = v2(c);
      for (b2 = g2.j(a); B2(b2) || b2.l(d2) > 0; ) c -= f, g2 = v2(c), b2 = g2.j(a);
      C2(g2) && (g2 = z);
      e = e.add(g2);
      d2 = F2(d2, b2);
    }
  ...
  h.and = function(d2) {
    const a = Math.max(this.g.length, d2.g.length), c = [];
    for (let f = 0; f < a; f++) c[f] = this.i(f) & d2.i(f);
  ...
  function I2(d2) {
    ...
    for (let f = 0; f < a; f++) c[f] = d2.i(f) << 1 | d2.i(f - 1) >>> 31;
    return new t(c, d2.h);
  }
  function J(d2, a) {
    const c = a >> 5;
    a %= 32;
    const f = d2.g.length - c, e = [];
    for (let g2 = 0; g2 < f; g2++) e[g2] = a > 0 ? d2.i(g2 + c) >>> a | d2.i(g2 + c + 1) << 32 - a : d2.i(g2 + c);
    return new t(e, d2.h);
  }
...
// node_modules/@firebase/firestore/dist/lite/common-73989ed6.esm.js
var User = class {
  constructor(e) {
    this.uid = e;
  }
...
var F = new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);
...
function __PRIVATE_typeOrder(e) {
  return "nullValue" in e ? 0 : "booleanValue" in e ? 1 : "integerValue" in e || "doubleValue" in e ? 2 : "timestampValue" in e ? 3 : "stringValue" in e ? 5 : "bytesValue" in e ? 6 : "referenceValue" in e ? 7 : "geoPointValue" in e ? 8 : "arrayValue" in e ? 9 : "mapValue" in e ? __PRIVATE_isServerTimestamp(e) ? 4 : (
    ...
    (function __PRIVATE_isMaxValue(e2) {
      return (((e2.mapValue || {}).fields || {}).__type__ || {}).stringValue === S;
    })(e) ? 9007199254740991 : (
      /** Returns true if `value` is a VetorValue. */
      (function __PRIVATE_isVectorValue(e2) {
        const t = (e2?.mapValue?.fields || {})[D]?.stringValue;
        return t === N;
      })(e) ? 10 : 11
    )
  ) : fail(28295, {
  ...
  switch (r) {
    ...
    case 10:
      return (function __PRIVATE_compareVectors(e2, t2) {
        const r2 = e2.fields || {}, n2 = t2.fields || {}, i = r2[O]?.arrayValue, s = n2[O]?.arrayValue, o = __PRIVATE_primitiveComparator(i?.values?.length || 0, s?.values?.length || 0);
        if (0 !== o) return o;
        return __PRIVATE_compareArrays(i, s);
      })(e.mapValue, t.mapValue);
    case 11:
      return (function __PRIVATE_compareMaps(e2, t2) {
        if (e2 === C && t2 === C) return 0;
        if (e2 === C) return 1;
        if (t2 === C) return -1;
...
function connectFirestoreEmulator(e, r, a, u = {}) {
  ...
  if (!deepEqual(f, l) && (e._setSettings(f), u.mockUserToken)) {
    let t, r2;
    if ("string" == typeof u.mockUserToken) t = u.mockUserToken, r2 = User.MOCK_USER;
    else {
...
var __PRIVATE_ArrayUnionFieldValueImpl = class ___PRIVATE_ArrayUnionFieldValueImpl extends FieldValue {
  ...
  _toFieldTransform(e) {
    const t = __PRIVATE_createSentinelChildContext(
      ...
      /*array=*/
      true
    ), r = this.G.map(((e2) => __PRIVATE_parseData(e2, t))), n = new __PRIVATE_ArrayUnionTransformOperation(r);
    return new FieldTransform(e.path, n);
  }
  isEqual(e) {
    return e instanceof ___PRIVATE_ArrayUnionFieldValueImpl && deepEqual(this.G, e.G);
  }
};
var __PRIVATE_ArrayRemoveFieldValueImpl = class ___PRIVATE_ArrayRemoveFieldValueImpl extends FieldValue {
  ...
  _toFieldTransform(e) {
    const t = __PRIVATE_createSentinelChildContext(
      ...
      /*array=*/
      true
    ), r = this.G.map(((e2) => __PRIVATE_parseData(e2, t))), n = new __PRIVATE_ArrayRemoveTransformOperation(r);
    return new FieldTransform(e.path, n);
  }
  isEqual(e) {
    return e instanceof ___PRIVATE_ArrayRemoveFieldValueImpl && deepEqual(this.G, e.G);
  }
};
var __PRIVATE_NumericIncrementFieldValueImpl = class ___PRIVATE_NumericIncrementFieldValueImpl extends FieldValue {
  ...
  isEqual(e) {
    return e instanceof ___PRIVATE_NumericIncrementFieldValueImpl && this.W === e.W;
  }
};
...
function __PRIVATE_parseUpdateVarargs(e, t, r, n, i, s) {
  const o = e.createContext(1, t, r), u = [__PRIVATE_fieldPathFromArgument(t, n, r)], _ = [i];
  ...
  for (let e2 = u.length - 1; e2 >= 0; --e2) if (!__PRIVATE_fieldMaskContains(c, u[e2])) {
    ...
    const n2 = o.childContextForFieldPath(t2);
...
function __PRIVATE_parseData(e, t) {
  ...
  return (function __PRIVATE_parseScalarValue(e2, t2) {
    ...
    if (e2 instanceof DocumentReference) {
      ...
      if (!n.isEqual(r)) throw t2.createError(`Document reference is for database ${n.projectId}/${n.database} but should be for database ${r.projectId}/${r.database}`);
      return {
...
function __PRIVATE_fieldPathFromDotSeparatedString(e, t, r) {
  if (t.search(j) >= 0) throw createError(
...
var AbstractUserDataWriter = class {
  ...
  convertVectorValue(e) {
    const t = e.fields?.[O].arrayValue?.values?.map(((e2) => __PRIVATE_normalizeNumber(e2.doubleValue)));
...
var __PRIVATE_ExponentialBackoff = class {
  constructor(t, e, s = 1e3, i = 1.5, r = 6e4) {
    this.t = t, this.timerId = e, this.i = s, this.o = i, this.h = r, this.u = 0, this.l = null, /** The last backoff attempt, as epoch milliseconds. */
  ...
  A(t) {
    ...
    i > 0 && __PRIVATE_logDebug("ExponentialBackoff", `Backing off for ${i} ms (base delay: ${this.u} ms, delay with jitter: ${e} ms, last attempt: ${s} ms ago)`), this.l = this.t.enqueueAfterDelay(this.timerId, i, (() => (this._ = Date.now(), t()))), // Apply backoff factor to determine next delay and ensure it is within
    // bounds.
...
var AggregateQuerySnapshot = class {
  /** @hideconstructor */
  constructor(t, e, s) {
    this._userDataWriter = e, this._data = s, /** A type string to uniquely identify instances of this class. */
...
function getAggregate(t, e) {
  const s = __PRIVATE_cast(t.firestore, Firestore), i = __PRIVATE_getDatastore(s), r = __PRIVATE_mapToArray(e, ((t2, e2) => new __PRIVATE_AggregateImpl(e2, t2.aggregateType, t2._internalFieldPath)));
  return __PRIVATE_invokeRunAggregationQueryRpc(i, t._query, r).then(((e2) => (function __PRIVATE_convertToAggregateQuerySnapshot(t2, e3, s2) {
    const i2 = new __PRIVATE_LiteUserDataWriter(t2), r2 = new AggregateQuerySnapshot(e3, i2, s2);
    return r2;
  })(s, t, e2)));
}
function sum(t) {
...
var WriteBatch = class {
  ...
  update(t, e, s, ...i) {
    ...
    let a;
    return a = "string" == typeof (e = getModularInstance(e)) || e instanceof FieldPath ? __PRIVATE_parseUpdateVarargs(this._dataReader, "WriteBatch.update", r._key, e, s, i) : __PRIVATE_parseUpdateData(this._dataReader, "WriteBatch.update", r._key, e), this._mutations.push(a.toMutation(r._key, Precondition.exists(true))), this;
  }
  /**
...
var __PRIVATE_TransactionRunner = class {
  constructor(t, e, s, i, r) {
    this.asyncQueue = t, this.datastore = e, this.options = s, this.updateFunction = i, this.deferred = r, this.I = s.maxAttempts, this.P = new __PRIVATE_ExponentialBackoff(
      this.asyncQueue,
      "transaction_retry"
...
var DelayedOperation = class _DelayedOperation {
  ...
  static createAndSchedule(t, e, s, i, r) {
    const a = Date.now() + s, n = new _DelayedOperation(t, e, a, i, r);
    return n.start(s), n;
  }
  /**
...
var __PRIVATE_AsyncQueueImpl = class {
  constructor(t = Promise.resolve()) {
    ...
    this.L = () => {
      ...
      t2 && __PRIVATE_logDebug(ft, "Visibility state changed to " + t2.visibilityState), this.P.T();
    }, this.W = t;
    const e = getDocument();
  ...
  enqueueAfterDelay(t, e, s) {
    ...
    const i = DelayedOperation.createAndSchedule(this, t, e, s, ((t2) => this.G(t2)));
...
var Transaction = class {
  ...
  update(t, e, s, ...i) {
    const r = __PRIVATE_validateReference(t, this._firestore);
    let a;
    return a = "string" == typeof (e = getModularInstance(e)) || e instanceof FieldPath ? __PRIVATE_parseUpdateVarargs(this._dataReader, "Transaction.update", r._key, e, s, i) : __PRIVATE_parseUpdateData(this._dataReader, "Transaction.update", r._key, e), this._transaction.update(r._key, a), this;
  }
  /**
   * Deletes the document referred to by the provided {@link DocumentReference}.
   *
...
function runTransaction(t, e, s) {
  ...
  })(), i, r, ((s2) => e(new Transaction(t, s2))), a).V(), a.promise;
}
